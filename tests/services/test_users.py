...
from project.exceptions import ItemNotFound, BadRequestData
...
class TestUsersService:
    ...
    def test_calc_password_difficulty(self):
        assert UsersService.calc_password_difficulty("") == 0
        assert UsersService.calc_password_difficulty("1234567") == 1
        assert UsersService.calc_password_difficulty("abcdefg") == 1
        assert UsersService.calc_password_difficulty("!@#$%^&") == 1
        assert UsersService.calc_password_difficulty("a1") == 2
        assert UsersService.calc_password_difficulty("aA") == 2
        assert UsersService.calc_password_difficulty("!A") == 2
        assert UsersService.calc_password_difficulty("!1") == 2
        assert UsersService.calc_password_difficulty("1aA!") == 4
        assert UsersService.calc_password_difficulty("1aA!1234") == 5
